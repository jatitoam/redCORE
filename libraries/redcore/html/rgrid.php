...
abstract class JHtmlRgrid
{
	...
	public static function order($rows, $task = 'saveorder')
	{
		...
		. JText::_('JLIB_HTML_SAVE_ORDER') . '"><i class="fa fa-save"></i></a>';
	}
		...
		$enabled = true, $translate = true, $checkbox = 'cb', $formId = 'adminForm')
	{
		...
		else
		{
			...
			{
				$html[] = '<i class="fa fa-' . $inactive_class . '"></i>';
			}
		...
		$checkbox = 'cb', $publish_up = null, $publish_down = null, $formId = 'adminForm')
	{
		...
		$states = array(1 => array('unpublish', 'JPUBLISHED', 'JLIB_HTML_UNPUBLISH_ITEM', 'JPUBLISHED', false, 'ok-sign fa fa-green', 'ok-sign fa fa-green'),
			0 => array('publish', 'JUNPUBLISHED', 'JLIB_HTML_PUBLISH_ITEM', 'JUNPUBLISHED', false, 'remove fa fa-red', 'remove fa fa-red'),
		...
		$task = null, $new_direction = 'asc', $tip = '', $icon = null, $formId = 'adminForm')
	{
		...
		$orderIcons = array('fa fa-chevron-up', 'fa fa-chevron-down');
